...
public class FastBoat {

	private UUID uuid;
    // Support
    private double maxForeMultiplier = 1, maxAftMultiplier = 0.3;
    // Packet data
    private float packetTurnValue = 0, packetForeAftValue = 0;
    // Momentum
    private double curHorizontalMultiplier = 0, curVerticalMultiplier = 0;
    // Reference
    private Boat boat;
    private Player player;
    private Location lastPlayerLocation;
    private double lastTotalVectorMagnitude, lastPlayerLocationY;

    // Constructor
    public FastBoat(UUID uuid,Boat boat) {
        this.boat = boat;
        maxForeMultiplier = BoatManager.MAX_SPEED_MULTIPLIER;
        if (maxForeMultiplier <= 0)  maxForeMultiplier = 1;
